...
import org.ado.interfaces.CoreDetails;
...
public class CoreApi implements CoreDetails {
     ...
     */
    @Override
    public Processes getProcesses() throws AdoException {
     ...
     */
    @Override
    public OperationReference createProject(String projectName, String description) throws AdoException {
     ...
     */
    @Override
    public OperationReference deleteProject(String projectId) throws AdoException {
     ...
     */
    @Override
    public Project getProject(String projectName) throws AdoException {
     ...
     */
    @Override
    public Project getProject(String projectName, boolean includeCapabilities, boolean includeHistory) throws AdoException {
     ...
     */
    @Override
    public ProjectProperties getProjectProperties(String projectId) throws AdoException {
     ...
     */
    @Override
    public Projects getProjects() throws AdoException {
     ...
     */
    @Override
    public OperationReference updateProject(String projectId, Project projectParameters) throws AdoException {
     ...
     */
    @Override
    public WebApiTeam createTeam(String projectName, String teamName) throws AdoException {
     ...
     */
    @Override
    public Void deleteTeam(String projectName, String teamName) throws AdoException {
        try {
            String r = send(RequestMethod.DELETE, CONNECTION, CORE, null,
     ...
     */
    @Override
    public Team getTeam(String projectName, String teamName) throws AdoException {
     ...
     */
    @Override
    public Team getTeam(String projectName, String teamName, boolean expandIdentity) throws AdoException {
     ...
     */
    @Override
    public Teams getTeams() throws AdoException {
     ...
     */
    @Override
    public Teams getTeams(boolean expandIdentity, String mine, int skip, int top) throws AdoException {
     ...
     */
    @Override
    public Team updateTeams(String projectName, String teamName, String description) throws AdoException {
     ...
     */
    @Override
    public Optional<Boolean> getFeatureState(String projectId, FeatureManagement feature) throws AdoException {
     ...
     */
    @Override
    public ProjectFeature featureToggle(String projectId, FeatureManagement feature, boolean state) throws AdoException {
