...
import org.ado.common.types.LocationUrl;
import org.ado.enums.ApiExceptionTypes;
import org.ado.enums.Instance;
...
public final class RestClientProvider extends BaseRestClient {
     ...
     */
    private static String getLocationUrl(String resourceID, String organizationName) throws AdoException {
        ...
        try {
            ...
            throw new AdoException(ApiExceptionTypes.InvalidOrganizationNameException.name(),
     ...
     * @throws AdoException throws user understandable error message with error code from API
     */
    protected static String buildRequestUrl(
            ...
            String resource,
            String apiVersion,
            Map<String, Object> queryString) throws AdoException {
